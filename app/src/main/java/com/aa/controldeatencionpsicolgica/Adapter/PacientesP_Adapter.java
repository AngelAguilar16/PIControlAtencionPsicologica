...
public class PacientesP_Adapter extends ArrayAdapter<Paciente_peritaje> {

    private List<Paciente_peritaje> pacienteList;
    private Context mCtx;

    public PacientesP_Adapter(List<Paciente_peritaje> P, Context c){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        name.setText(paciente.getNombres() + " " + paciente.getAp() + " " + paciente.getAm());
